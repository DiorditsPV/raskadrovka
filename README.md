...
Локальное окно в репозиторий: книги и их прогресс, записи героев с аудитом понимания и
результатом проверки, партии, направления стиля с эталонами, очередь заданий с логами.
Шаги, где нужно суждение, панель отдаёт Codex сама и сама проверяет результат; отбор героев
и сцен остаётся за человеком. Ничего своего панель не хранит — состояние это те же файлы,
и шаг, сделанный руками в терминале, она увидит.
