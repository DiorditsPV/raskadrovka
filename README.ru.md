...
![Экран «Персонажи»: запись, аудит понимания и промпт листа](docs/screens/characters.png)

*Запись раскрыта: десять клеток поимённо, чего книга не даёт, и ровно тот текст, что уйдёт
генератору. На снимке интерфейс английский — переключатель в боковине.*
...
Интерфейс двуязычный — русский и английский, переключатель в боковине. Переводится только
